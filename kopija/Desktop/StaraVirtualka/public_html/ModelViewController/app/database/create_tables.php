...
function create_table_users()
{
	...
	// Svaki user ima svoj id (automatski Ä‡e se poveÄ‡ati za svakog novoubaÄŤenog korisnika), ime, prezime i password hash.
	try
	{
		$st = $db->prepare(
...
function create_table_books()
{
	...
	// Svaka knjiga ima svoj id (automatski Ä‡e se poveÄ‡ati za svaku novoubaÄŤenu knjigu), ime autora i naslov.
	try
	{
		$st = $db->prepare(
...
function create_table_loans()
{
	...
	// Svaka posudba ima svoj id (automatski Ä‡e se poveÄ‡ati za svaku novoubaÄŤenu knjigu), id korisnika koji je posudio
	// knjigu, id knjige koja se posuÄ‘uje, te datum isteka posudbe.
	try
	{
		$st = $db->prepare(
